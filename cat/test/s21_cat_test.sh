...
testing(){
    ./s21_cat $var test/bytes.txt> test/test_s21_cat.log 
    cat $var test/bytes.txt> test/test_cat.log
    if cmp -s test/test_s21_cat.log test/test_cat.log
    then
    (( SUCCESS++ ))
    (( COUNTER++ ))
    ...
    rm test/test_s21_cat.log test/test_cat.log
}
